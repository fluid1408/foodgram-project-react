    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, db_index=True, max_length=200, verbose_name='имя')),
                ('last_name', models.CharField(blank=True, db_index=True, max_length=200, verbose_name='фамилия')),
